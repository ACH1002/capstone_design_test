...
class SensorRepository(private val context: Context) {
    ...
    private var measurementStartTime: Long = 0  // 밀리초 단위로 시작 시간 저장
    ...
    fun startDataCollection() {
        isCollecting = true
        measurementStartTime = System.currentTimeMillis()  // 밀리초 단위로 시작 시간 기록
        startTime = System.nanoTime()
        dataList.clear()
        dataList.add(listOf("Time(s)", "AccX", "AccY", "AccZ", "GyroX", "GyroY", "GyroZ", "MagX", "MagY", "MagZ", "Latitude", "Longitude"))
    ...
    private fun updateSensorData() {
        ...
        val elapsedSeconds = (currentTimeMillis - measurementStartTime) / 1000.0  // 초 단위로 변환
        ...
        val data = listOf(
            String.format("%.3f", elapsedSeconds),  // 소수점 3자리까지 표시
